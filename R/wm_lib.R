...
#'Prepare data for ``sandwrm`` analysis
#'
#'@param genDist Matrix of pairwise genetic distance.
#'@param geoDist Matrix of pairwise geographic distance.
#'@param L Number of independent loci.
#'@param k Kappa.
#'@example
#'data("example_locs", "example_pwp")
#'coords <- example_locs[,c("x","y")]
#'geoDist <- fields::rdist(coords)
#'genDist <- as.matrix(example_pwp)
#'dataBlock <- prepareData(genDist=genDist, geoDist=geoDist, L=1e4, k=0.25)
#'print(dataBlock)
...
#'Bayesian estimation of parameters of the Wright-Malecot model.
#'@param dataBlock Block of data generated by `prepareData`
#'@param nChains Number of MCMC chains.
#'@param nIter Number of iterations in each chain. Minimum is 2000.
#'@example
...
#'Plot histogram of estimated nbhd
