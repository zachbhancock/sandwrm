...
For those with low-coverage, whole-genome sequencing, many programs, such as `ANGSD`, rely on a genotype-likelihood approach to estimate SNPs. Researchers can then utilize programs such as `distANGSD` to generate a pairwise genetic distance matrix (see [documentation](https://github.com/lz398/distAngsd)).  
